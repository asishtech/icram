...
export default function InauguralInvitationPage() {
  ...
  useEffect(() => {
    ...
    link.rel = 'prefetch';
    link.href = '/inaugural-invitation.pdf';
    link.as = 'document';
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-gray-100/60 overflow-hidden">
            ...
            <div className="px-4 sm:px-8 py-4 sm:py-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-semibold text-gray-900">
                      ICRAM&apos;26 Inaugural Ceremony Invitation
                    </h3>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                  ...
                  <a
                    href="/inaugural-invitation.pdf"
                    download="ICRAM26_Inaugural_Invitation.pdf"
            ...
            <div className="relative bg-white">
              ...
              {!pdfLoaded && (
                <div className="absolute inset-0 flex items-center justify-center bg-white z-10 min-h-[500px] animate-fadeIn">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-sm text-gray-600 font-medium">Loading invitation...</p>
                  </div>
                </div>
              )}
              ...
              <div className="relative bg-white">
                <iframe
                  src="/inaugural-invitation.pdf#toolbar=1&navpanes=1&scrollbar=1&view=FitH"
                  className="w-full h-[500px] sm:h-[700px] md:h-[800px] lg:h-[900px] border-0 bg-white"
                  title="ICRAM 26 Inaugural Invitation"
                  onLoad={() => {

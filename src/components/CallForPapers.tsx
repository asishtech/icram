      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-5 text-gray-500 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
            ...
            submit original contributions to ICRAM 2026 across all conference
            themes.
          </p>
        </div>
            ...
            <div className="p-8 sm:p-10">
              ...
              {activeTab === "abstract" && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 text-black leading-relaxed">
                    <p>
                      Submit your abstract now and be part of ICRAM&apos;26!
                    </p>

                    <p>
                      All accepted extended abstracts will be published in the
                      Book of Abstracts, to which an online ISBN will be
                      assigned.
                    </p>
              ...
              {activeTab === "fullpaper" && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 text-black leading-relaxed">
                    <p>
                      All submitted papers will be reviewed by the guest
                      editorial team, and shortlisted papers will have the
                      opportunity to undergo the standard review process of
                      selected journals as part of the special issue.
                    </p>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mt-6">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start gap-2.5 text-gray-700">
                          ...
                          <span>
                            Full papers must follow prescribed format of the
                            respective journals.
                          </span>
                        </li>
                        ...
                        <li className="flex items-start gap-2.5 text-gray-700">
                          <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-amber-400 shrink-0" />
                          <span>
                            All submissions must be novel and original work, and
                        ...
                        <li className="flex items-start gap-2.5 text-gray-700">
                          <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-amber-400 shrink-0" />
                          <span>
                            Authors will be notified the status after
              ...
              {activeTab === "oral" && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 text-black leading-relaxed">
                    <p>
                      Present your research findings in person through a
                      structured talk in 10 minutes. Ideal for sharing detailed
                      methodologies and engaging directly with the audience.
                    </p>
                  </div>
                </div>
              )}
              ...
              {activeTab === "poster" && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 text-black leading-relaxed">
                    <p>
                      Showcase your work through a visually engaging poster
                      display during dedicated sessions. A great opportunity for
                      one-on-one discussions with fellow researchers.
                    </p>
              ...
              {activeTab === "virtual" && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 text-black leading-relaxed">
                    <p>
                      Participate remotely via our hybrid conference platform.
                      Present your research through a live video session with
                      real-time interaction and global accessibility.
                    </p>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-lg shadow-gray-100/60 p-8 sm:p-10">
            ...
            <div className="flex flex-col items-center justify-center py-10 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50/50">
              ...
              <p className="text-gray-400 text-sm max-w-md text-center">
                Information about best paper awards, young researcher awards,
                and other recognitions will be announced shortly.
              </p>
            </div>
          </div>
        </div>

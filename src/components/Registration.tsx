    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          {/* Notes */}
          <br />
          <div className="flex items-start gap-2 text-lg sm:text-xl">
            <span className="mt-3 w-2.5 h-2.5 rounded-full bg-amber-400 shrink-0" />

            <span className="font-extrabold text-[#C71223] leading-relaxed">
              Big Update! Free Accommodation for students and scholars, and on minimal charge basis for others. Register now!!
            </span>
          </div>

...
const events: TimelineEvent[] = [
  ...
  },
  {
    ...
    date: (
      <span>
        <span className="line-through decoration-[#C71223] decoration-2">10th June 2026</span>{" "}
        <span className="text-[#c4a335] font-bold">17th June 2026</span>
      </span>
    ),
...
function TimelineNode({
  ...
  return (
    <div className="relative flex items-center w-full group">
      ...
      {/* Left content area */}
      <div
        className={`hidden md:flex w-[calc(50%-1.5rem)] ${isLeft ? "justify-end" : "justify-end opacity-0 pointer-events-none"
          }`}
      >
        {isLeft && (
      ...
      {/* Right content area */}
      <div
        className={`hidden md:flex w-[calc(50%-1.5rem)] ${!isLeft ? "justify-start" : "justify-start opacity-0 pointer-events-none"
          }`}
      >
        {!isLeft && (

...
const nextConfig: NextConfig = {
  ...
  allowedDevOrigins: [
    'preview-aqcestpwheoz.share.sandbox.dev',
    'preview-azcxigadiufj.share.sandbox.dev',
    'preview-eipjkzqnzjhz.share.sandbox.dev',
    ...
    'preview-fpucqizjqqvt.share.sandbox.dev',
  ],
